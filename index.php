...
<body>
    <main>
        ...
        <p>Severin, Pfeiffer</p>
        E-Mail-Adresse: <p><a href="mailto:Severin.pfeiffer@stud.kftg.ch">Severin.pfeiffer@stud.kftg.ch</a></p>
        ...
        <ul class="m-elements">
            ...
            <li><strong>Zwecke der Verarbeitung:</strong> Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit; Informationstechnische Infrastruktur (Betrieb und Bereitstellung von Informationssystemen und technischen Geräten (Computer, Server etc.).).</li>
        ...
        <form name="form1" method="post" action="index2.php">
            <div class="form-group">
                <input type="submit" value="Akzeptieren" name="submit" class="button button1" />
            </div>
        </form>
    </main>
</body>
